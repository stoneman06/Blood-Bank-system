...
<body>
  ...
  <div id="page-container" style="margin-top:50px; position: relative;min-height: 84vh;    background: linear-gradient(to bottom, #ffffff 0%, #f6e4e4 100%);">
    <div class="container">
    <div id="content-wrap" style="padding-bottom:50px;">

  <div class="row" style = "     align-items: center; flex-direction: column;" >
      <div class="col-lg-6 " style = "text-align: -webkit-center;" >
          <h1 class="mt-4 mb-3" style = " color : red;" >Need Blood</h1>
  ...
  <div class="font-italic" style = "padding-bottom:10px;padding-top:10px;" >Blood Group<span style="color:red;" >*</span></div>
...
<div class="col-lg-4 mb-4">
<div class="font-italic"style = "padding-bottom:10px;padding-top:10px;">How urgent is the blood required?</div>
